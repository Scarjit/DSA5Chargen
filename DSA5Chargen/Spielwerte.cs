namespace DSA5Chargen
{
    ...
    public partial class Spielwerte : MetroForm
    {
        ...
        private void nud_fingerfertigkeit_ValueChanged(object sender, EventArgs e)
        {
            Charakter.Fingerfertigkeit = int.Parse(this.nud_fingerfertigkeit.Text);
        }

        private void nud_geschicklichkeit_ValueChanged(object sender, EventArgs e)
        {
            Charakter.Geschicklichkeit = int.Parse(this.nud_geschicklichkeit.Text);
        }

        private void nud_intuiton_ValueChanged(object sender, EventArgs e)
        {
            Charakter.Intuition = int.Parse(this.nud_intuiton.Text);
        }

        private void nud_klugheit_ValueChanged(object sender, EventArgs e)
        {
            Charakter.Klugheit = int.Parse(this.nud_klugheit.Text);
        }

        private void nud_konstitution_ValueChanged(object sender, EventArgs e)
        {
            Charakter.Konstitution = int.Parse(this.nud_konstitution.Text);
        }

        private void nud_körperkraft_ValueChanged(object sender, EventArgs e)
        {
            Charakter.Körperkraft = int.Parse(this.nud_körperkraft.Text);
        }

        private void nud_mut_ValueChanged(object sender, EventArgs e)
        {
        ...
        private void Spielwerte_VisibleChanged(object sender, EventArgs e)
        {
